...
class VSeamCarver2:
    ...
    "Forward energy image compression, shrinks the image width"
    ...
    def energy(self, x, y):
        ...
        elif x == 0:                                                                            # i prolly could have done this in one file
    ...
    def removeverticalseam(self, path):
        ...
        for pixel in path:
            ...
            if x == 0:                                              
                self.energy_list[y][x] = self.energy(x, y)               # checks where was the points was and decides which pixels to re calculate
                if y < self.height - 1:
